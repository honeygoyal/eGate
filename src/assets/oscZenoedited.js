...
$(document).ready(function () {
  ...
  $("div#keyPad a.keyPad_btnNumeric").click(function () {
    ...
    if (
      ...
      inBox1.val("");
      return;
    } else if (this.id == "keyPad_btnDot" && str.indexOf(".") >= 0) return;
    displayCheck();
  ...
  $("a.keyPad_btnUnaryOp").click(function () {
    ...
    switch (this.id) {
      ...
      // Secant
      case "keyPad_btnSec":
        retVal = secCalc(modeSelected, x);
        break;
      // Cosecant
      case "keyPad_btnCosec":
        retVal = cosecCalc(modeSelected, x);
        break;

      // sinh
      case "keyPad_btnSinH":
        retVal = (Math.pow(Math.E, x) - Math.pow(Math.E, -x)) / 2;
        modeText($("#" + this.id).text(), x);
        break;
      // cosh
      ...
      // Secant hyperbolic
      case "keyPad_btnSecH":
        retVal = 2 / (Math.pow(Math.E, x) + Math.pow(Math.E, -x));
        break;
      // Cosecant hyperbolic
